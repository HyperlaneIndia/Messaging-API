...
import {IMailbox} from ".deps/npm/@hyperlane-xyz/core/contracts/interfaces/IMailbox.sol";
import {IPostDispatchHook} from ".deps/npm/@hyperlane-xyz/core/contracts/interfaces/hooks/IPostDispatchHook.sol";
import {IInterchainSecurityModule} from ".deps/npm/@hyperlane-xyz/core/contracts/interfaces/IInterchainSecurityModule.sol";

import {Address} from "@openzeppelin/contracts/utils/Address.sol";
import {OwnableUpgradeable} from "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";

contract VoteMain is OwnableUpgradeable {
    ...
    // function _MailboxClient_initialize(address _interchainSecurityModule)
    //     internal
    //     onlyInitializing
    // {
    ...
    function createProposal(
        ...
        proposalId = uint256(
            keccak256(abi.encode(_title, _description, _votingPeriod))
        );
        require(
